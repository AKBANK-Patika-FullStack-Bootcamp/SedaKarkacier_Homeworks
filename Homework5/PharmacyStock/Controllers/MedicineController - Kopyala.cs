...
namespace PharmacyStock.Controllers
{
    ...
    public class MedicineController : ControllerBase
    {
        public List<Medicine> AddMedicines()
        {
            ...
            mdcn.Add(new Medicine { Id = 1, MedicineName = "ABILIFY 30 mg Tablet", Company = "Koçak", InfluenceGroup = "Antibiotic", Price = 13, Stock = 21, FeatureId = 1});
            mdcn.Add(new Medicine { Id = 2, MedicineName = "ARVELES 25 mg Tablet", Company = "Menarini International", InfluenceGroup = "Painkiller", Price = 17, Stock = 25, FeatureId = 2 });
            mdcn.Add(new Medicine { Id = 3, MedicineName = "BENICAL COLD 20 Film Tablet", Company = "Bayer", InfluenceGroup = "Common Cold", Price = 12, Stock = 11, FeatureId = 3 });
        ...
        MedicineContext medicineDbOperation = new MedicineContext();

        [HttpGet]
        public List<Medicine> GetMedicines()
        {
            //Listedeki ilaçlar getirilecek
            //medicinesList = medicineDbOperation.Medicine.OrderBy(x => x.Id).ToList();
